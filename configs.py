...
def create_prep_config_future100(str_network='', cfg_model_params=None, input_size=224, pixel_size=[0.5, 0.5], ego_center=[0.25, 0.5],
                  batch_size=12, num_workers=16, samples_per_epoch=0, sample_history_num_frames=10,
                  history_num_frames=10, future_num_frames=100, n_modes=3,
                  max_agents=40, n_input_channels=(10 + 1) * 2 + 3, n_output=50 * 3, history_step_size=1):
    cfg = {
        'format_version': 4,
        'model_params': {
...
def create_config_multi_chopped_lite_future100(str_network='', cfg_model_params=None, input_size=224, pixel_size=[0.5, 0.5],
                                                   ego_center=[0.25, 0.5], batch_size=12, num_workers=16, samples_per_epoch=0,
                                                   sample_history_num_frames=10, history_num_frames=10, future_num_frames=100,
                                                   n_modes=3,
    ...
    cfg = {
        ...
        'train_data_loader_10': {
            'key': 'scenes/train_full_chopped_10_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_10_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_10_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_20': {
            'key': 'scenes/train_full_chopped_20_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_20_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_20_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_30': {
            'key': 'scenes/train_full_chopped_30_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_30_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_30_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_50': {
            'key': 'scenes/train_full_chopped_50_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_50_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_50_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_70': {
            'key': 'scenes/train_full_chopped_70_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_70_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_70_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_80': {
            'key': 'scenes/train_full_chopped_80_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_80_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_80_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_90': {
            'key': 'scenes/train_full_chopped_90_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_90_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_90_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_100': {
            'key': 'scenes/train_full_chopped_100_lite_100_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_100_lite_100_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_100_lite_100_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_120': {
            'key': 'scenes/train_full_chopped_120_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_120_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_120_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_130': {
            'key': 'scenes/train_full_chopped_130_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_130_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_130_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_140': {
            'key': 'scenes/train_full_chopped_140_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_140_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_140_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_150': {
            'key': 'scenes/train_full_chopped_150_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_150_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_150_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_160': {
            'key': 'scenes/train_full_chopped_160_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_160_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_160_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_170': {
            'key': 'scenes/train_full_chopped_170_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_170_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_170_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
        ...
        'train_data_loader_200': {
            'key': 'scenes/train_full_chopped_200_lite_10_100/train_full.zarr',
            'gt_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_200_lite_10_100/gt.csv'),
            'mask_path': os.path.join(BASE_DIR, 'scenes/train_full_chopped_200_lite_10_100/mask.npz'),
            'batch_size': batch_size,
            'shuffle': True,
            'num_workers': num_workers,
            'samples_per_epoch': samples_per_epoch
...
def create_config_multi_train_chopped_lite_100(str_network='', cfg_model_params=None, input_size=224, pixel_size=[0.5, 0.5], ego_center=[0.25, 0.5], batch_size=12, num_workers=16, samples_per_epoch=0, sample_history_num_frames=10, history_num_frames=10, future_num_frames=50, n_modes=3,
                    max_agents=40, n_input_channels=(10 + 1)*2 + 3, n_output=50*3, history_step_size=1):
